...
const Home = () => {
  ...
  return (
    <ClientOnly>
      <Container>
        <div
          className="pt-10 text-center relative bg-cover bg-center"
          style={{ backgroundImage: 'url("/images/provence.jpg")' }}
        >
          <div className="bg-white bg-opacity-75 p-10 rounded-md shadow-md">
